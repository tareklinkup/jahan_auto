...
<div id="cashTransaction">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-5 col-md-offset-1">
                        <div class="form-group">
                            <label class="col-xs-4 control-label">Transaction Id</label>
                        ...
                        <div class="form-group">
                            <label class="col-xs-4 control-label">Trans Type</label>
                            <label class="col-xs-1">:</label>
                            <div class="col-xs-7">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12 form-inline">
            <div class="form-group">
