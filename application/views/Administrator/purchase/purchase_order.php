                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Payment
                                                    Type</label>
                                                <div class="col-xs-12">
                                                    <select class="form-control" v-model="purchase.payment_type"
...
new Vue({
    ...
    methods: {
        ...
        savePurchase() {
            ...
            if (this.purchase.payment_type == 'bank' && this.selectedAccount.account_id == null) {
                alert('Select bank account');
                return;
            }
            if (this.purchase.payment_type == 'bank' && this.purchase.paid == 0) {
