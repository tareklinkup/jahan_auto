    ...
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            <div class="form-group">
                <label class="col-sm-1 col-lg-1 control-label no-padding-right"> Invoice no </label>
            ...
            <div class="form-group">
                <label class="col-sm-1 col-lg-1 control-label no-padding-right"> Sales By </label>
                <div class="col-sm-2 col-lg-2">
            ...
            <div class="form-group">
                <label class="col-sm-1 col-lg-1 control-label no-padding-right"> Sales From </label>
                <div class="col-sm-2 col-lg-2">
                ...
                <div class="widget-main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-lg-2 row productdetails">
                            <div class="col-xs-8 col-lg-12" style="display:none;"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="paid" class="form-control"
                                                        ...
                                                        v-bind:disabled="selectedCustomer.Customer_Type == 'G' || sales.payment_type == 'bank'  ? true : false" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
new Vue({
    ...
    methods: {
        ...
        async saveSales() {
            ...
            if (this.sales.payment_type == 'bank' && this.selectedAccount.account_id == null) {
            ...
            this.sales.account_id = this.selectedAccount != null && this.selectedAccount.account_id != '' ?
